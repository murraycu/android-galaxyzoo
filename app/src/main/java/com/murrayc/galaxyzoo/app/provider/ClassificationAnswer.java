...
public class ClassificationAnswer {
     ...
     */
    public static final Uri CLASSIFICATION_ANSWERS_URI = Uri.parse("content://" +
            AUTHORITY + "/" + ItemsContentProvider.URI_PART_CLASSIFICATION_ANSWER);
    /**
     * The content:// style URI for this item.
     */
    public static final Uri CONTENT_URI = CLASSIFICATION_ANSWERS_URI;
